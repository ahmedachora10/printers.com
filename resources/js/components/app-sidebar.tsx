...
import { ArrowLeftRight, Award, Bell, Bike, BookOpen, Boxes, CalendarDays, ChartPie, ClipboardCheck, ClipboardList, FileText, FolderKanban, GitBranch, Handshake, History, LayoutGrid, LucideIcon, Package, Receipt, ServerIcon, Settings, ShoppingBasket, ShoppingCart, Tags, Ticket, TrendingUp, Trophy, Truck, Undo2, User, Users, Wallet } from 'lucide-react';

    ...
    return (
        <main
            ...
            className={cn(
                ...
                // descendant, and a wide table drags the whole document sideways
                // instead of scrolling inside its own container.
                'relative flex min-h-svh min-w-0 flex-1 flex-col bg-background',
                'peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] lg:peer-data-[variant=inset]:m-2 lg:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 lg:peer-data-[variant=inset]:ml-0 lg:peer-data-[variant=inset]:rounded-md lg:peer-data-[variant=inset]:shadow-sm',
                className,
            )}
            {...props}
        />

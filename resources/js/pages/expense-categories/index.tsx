import { destroy, index, toggleStatus } from '@/actions/App/Http/Controllers/ExpenseCategoryController';
import ExpenseCategoryFormModal from '@/components/expense-categories/expense-category-form-modal';
...
import { type PaginatedExpenseCategory, type ExpenseCategory } from '@/types/expense-category';
import { router } from '@inertiajs/react';
import { Plus, Pencil, Trash2 } from 'lucide-react';
import { useMemo, useRef, useState } from 'react';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'فئات المصروفات', href: '/expense-categories' },
];
...
export default function ExpenseCategoriesIndex({ items, filters }: Props) {
    ...
    function handleToggleStatus(item: ExpenseCategory) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="p-6">
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold">فئات المصروفات</h1>
                </div>

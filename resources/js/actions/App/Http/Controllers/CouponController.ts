 ...
 */
export const validateCoupon = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/coupons/validate'
 */
validateCoupon.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: validateCoupon.url(options),
    method: 'get',
})
/**
 ...
 * @route '/coupons/validate'
 */
validateCoupon.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: validateCoupon.url(options),
    method: 'head',
})

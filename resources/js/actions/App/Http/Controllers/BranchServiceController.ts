 ...
 * @see app/Http/Controllers/BranchServiceController.php:16
 ...
 * @see app/Http/Controllers/BranchServiceController.php:25
 ...
 * @see app/Http/Controllers/BranchServiceController.php:34
 * @route '/branch-services/{branch_service}'
 */
...
const BranchServiceController = { store, update, destroy }
